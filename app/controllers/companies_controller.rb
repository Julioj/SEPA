class CompaniesController < ApplicationController
  ...
  private
    ...
    def company_params
      params.require(:company).permit(:id, :industryTypeId, :employeeId, :name, :email, :address, :cuit, :comment, :suscription, :fantasy_name, :localidadId, :party, :postal_code, :type, :tlf, :internal_tlf, :contact, :visit_attributes=> [:id, :companyId, :visitTypeId, :frecuencyTypeId, :employeeId, :nextVisit, :visitDate, :aproved, :aprovalDate, :_destroy, :_update, :_save, :_create] )
    end
end
